...
const CreateProduct = () => {
    ...
    const handleSubmit = async(e)=>{
        ...
        formData.append("tags",PiTagSimple.trim())
        ...
        formData.append("price",price);
            ...
            console.log("FormData before ending....");
            formData.forEach((value,key)=>{
                console.log(key,value);
            });

            try{
                const response = await axios.post("https://localhost:8080/api//v2/product/create-product",formData,
                {
                    headers:{
